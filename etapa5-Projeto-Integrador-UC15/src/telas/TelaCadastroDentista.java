...
/**Tela aonde será digitado os valores para a criação e cadstro de um novo Dentista.*/
public class TelaCadastroDentista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblCadastroDentista = new javax.swing.JLabel();
        ...
        lblCadastroDentista.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        lblCadastroDentista.setText("Cadastro de Cirurgião Dentista");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(35, 35, 35)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtUfCro, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addComponent(lblCadastroDentista))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(4, 4, 4)
                        .addComponent(txtNome, javax.swing.GroupLayout.DEFAULT_SIZE, 39, Short.MAX_VALUE)))
    ...
    private javax.swing.JLabel lblCadastroDentista;
            ...
            try {
                ...
                try {
                    try {
                        ...
                        dentista.setNascimento(sqlDate);
                ...
                dentista.setCpf(txtCpf.getText());
                dentista.setUfCro(txtUfCro.getText());
                dentista.setCro(txtCro.getText());
                dentista.setEndereco(txtEndereco.getText());
                dentista.setTelefone(txtTelefone.getText());
                ...
                if (status == false) {
                    ...
                    resposta = dao.salvar(dentista);
                    switch (resposta) {
                        case 1:
                            telaPrincipal.atualizaTabelaDentista();
                            JOptionPane.showMessageDialog(null, "Cadastro de dentista efetuado com sucesso.");
                            break;
                        case 1062:
                            JOptionPane.showMessageDialog(null, "Dentista já foi cadastrado.");
                            break;
                        default:
